...
# this just sets the order of the factor, for plotting clarity
...
```{r eval=F}
library(heirfstat)
dist.out <-genet.dist(obj, method = "Dch") # you can change the method here if you'd like.
dist.out
...
# reorder individuals. very annoying. This could have been avoided if the input data were ordered better. Don't worry much about these details unless you want to.
